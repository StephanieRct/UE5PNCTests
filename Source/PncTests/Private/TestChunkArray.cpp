...
bool TestPnc_ChunkArray_Construct_StructData::RunTest(const FString& Parameters)
{
    ...
    auto* chunkArray = new PNC::ChunkArray(&fix.Data->StructureABVW, kSize_ChunkCount, kSize_NodeCountPerChunk);
...
bool TestPnc_ChunkArray_Construct_StructData_EmptyChunks::RunTest(const FString& Parameters)
{
    FIXSTART(Fix);
    ResetCallCounter();
    auto* chunkArray = new PNC::ChunkArray(&fix.Data->StructureABVW, kSize_ChunkCount, kSize_NodeCountPerChunk_0, kSize_ChunkCount * kSize_NodeCountPerChunk);
...
//
//IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestPnc_ChunkArray_Construct_StructData_EmptyArray, "Pnc.3-ChunkArray.0-Construct-StructData-EmptyArray", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
