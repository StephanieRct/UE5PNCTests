...
//
//IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestNi_UniformChunkArray_Construct_StructData, "Ni.3-NUniformArray.0-Construct-StructData", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
//bool TestNi_UniformChunkArray_Construct_StructData::RunTest(const FString& Parameters)
//{
//    FIXSTART(Fix);
//    ResetCallCounter();
